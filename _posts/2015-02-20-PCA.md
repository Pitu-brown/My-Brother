...
For simplicity, we will only retrieve 11 protein sequences form the Uniprotr, which are associated with Histone Deacetylase Protein Faimly.
...
#checkProtr function from Rcpi to remove wire
~~~
